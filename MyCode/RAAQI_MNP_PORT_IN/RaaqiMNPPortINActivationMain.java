...
public class RaaqiMNPPortINActivationMain {
...
*/		
		...
		xlFile = new File("C:\\Automated_Execution\\Input\\TestData_RaqiMNP.xls");
		...
		outputpath="C:\\Automated_Execution\\Output\\RaqiMNP\\".concat(output);
		...
		/*	report.writeToFile(reportfile, "-----------------------------------------"+System.lineSeparator()+"\tData Pre check\t"  +System.lineSeparator()+"------------------------------------------");
			...
			/*check=0;
			RaaqiMNPPortINProfileCreation prof=new RaaqiMNPPortINProfileCreation();
			check=prof.acti();
...
*/
			...
			check=0;
			RaaqiMNPPortINActivation acti=new RaaqiMNPPortINActivation();
