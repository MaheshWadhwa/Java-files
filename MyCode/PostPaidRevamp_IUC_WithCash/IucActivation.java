...
public class IucActivation {
	...
	public int iucActivate(int cellId) throws InterruptedException, IOException {
		...
		File xlFile = new File("C:\\Automated_Execution\\Input\\TestData_Revamp_IUC.xls");
...
/*		//Selecting the mode		
		String m1="//div[text()='";
		String m2="']/../../div/input";
		String m3=m1.concat(xMode).concat(m2);
		driver.findElement(By.xpath(m3)).click();
		
		//Click on customize image		
		driver.findElement(By.xpath("//img[@src='images/icon_configure.gif']")).click();
		
		//Selecting bundle			
		String b1="//option[text()='";
		String b2="']";
		String b3=b1.concat(xBundle).concat(b2);
		
		driver.findElement(By.xpath("//option[text()='Mode Supreme']/..")).click();
		...
		String s2="']";		
		String s3=s1.concat(xSlab).concat(s2);		
  	...
  	//	driver.findElement(By.xpath("//option[text()='Bundle Custom - Supreme']")).click();
		...
		driver.findElement(By.xpath("//button[text()='Add Item']/../../div/input")).sendKeys(xQuantity);
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//a[text()='Device with Cash']/../..//img[@title='Customize']")).click();
		Thread.sleep(15000);
/*		
		//Again selecting Slab
		s1="//option[text()='";
		s2="']";
		
		s3=s1.concat(xSlab).concat(s2);
		driver.findElement(By.xpath("//option[text()='Slab 1']/..")).click();
		driver.findElement(By.xpath(s3)).click();*/
...
/*		//Selecting the device		
		String d1="//option[text()='";
		String d2="']";
		String d3=d1.concat(xDevice).concat(d2);		
		
		driver.findElement(By.xpath("//option[text()='Sony Z']/..")).click();
		//driver.findElement(By.xpath("//option[text()='Sony Z']")).click();
		
		
		//Selecting contract
		
		String c1="//option[text()='";
		String c2="']";
		String c3=c1.concat(xContract).concat(c2);
