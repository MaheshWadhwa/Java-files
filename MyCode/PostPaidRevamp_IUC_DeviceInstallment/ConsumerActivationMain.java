...
public class ConsumerActivationMain {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException, SQLException 
	{
		...
		xlFile = new File("C:\\Automated_Execution\\Input\\TestData_Revamp_IUC_DeviceInstallment.xls");
		...
		outputpath="C:\\Automated_Execution\\Output\\Revamp_IUC_DeviceInstallment\\".concat(output);
...
*/
			...
			check=0;
			IucActivation acti=new IucActivation(runlog,reportfile,Actipre,report);
			check=acti.iucActivate(cellId);
