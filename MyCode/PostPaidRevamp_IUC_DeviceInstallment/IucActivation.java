package PostPaidRevamp_IUC_DeviceInstallment;
import java.io.File;
...
public class IucActivation {
	...
	public int iucActivate(int cellId) throws InterruptedException, IOException {
		...
		File xlFile = new File("C:\\Automated_Execution\\Input\\TestData_Revamp_IUC_DeviceInstallment.xls");
...
/*		
		...
		Thread.sleep(10000);*/
		    ...
		    // Click Device with Installment box
	  		driver.findElement(By.xpath("//div[text()='Device with Installment']/../../div/input")).click();
	  		Thread.sleep(5000);
	  		
		    //Click on Customize Image
		    driver.findElement(By.xpath("//a[text()='Device with Installment']/../../../div/span/a/img[@title='Customize']")).click();
		    report.writeTorun(runlog,"Clicked on Customize Image");		
		    Thread.sleep(10000);  
