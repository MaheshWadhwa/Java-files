...
public class SIMSwap{
	...
	public int simswap() throws InterruptedException, IOException 
	{
		...
		File xlFile = new File("C:\\Automated_Execution\\Input\\TestData_CUC_SIMSwap.xls");
		...
		String xMSISDN = row3.getCell(2).getStringCellValue();
		
		
		HSSFRow row5=testSheet.getRow(5);
		String newMSISDN = row3.getCell(2).getStringCellValue();
