...
public class DataCleanlinessCheck {
	...
	public DataCleanlinessCheck(String Sim, String Imsi, String Msisdn, String reportFile, String datasetLogFile, String datasetFolderPath, CommonUtilitiesWriterOLD utilities){
	...
	public int dataCheck()throws IOException, InterruptedException, ClassNotFoundException, SQLException
	{
		...
		{
			conditionCounter = 0;
			utilities.writeToFile(reportFile, "Data Cleanliness Check"+System.lineSeparator()+"----------------------");
//			System.out.println("Data Cleanliness Check");
	//		System.out.println("----------------------");
		...
		//		System.out.println("Cleanliness Check in Siebel - Fail");
				conditionCounter++;
			} else {
				utilities.writeToFile(reportFile, "Cleanliness Check in Siebel - Pass");
		//		System.out.println("Cleanliness Check in Siebel - Pass");
			}
		...
		//		System.out.println("Cleanliness Check in Billing - Fail");
				conditionCounter++;
			} else {
				utilities.writeToFile(reportFile, "Cleanliness Check in Billing - Pass");
		//		System.out.println("Cleanliness Check in Billing - Pass");
			}
		...
		//		System.out.println("Cleanliness Check in MED_AUC_DATA table - Fail");
				conditionCounter++;
			} else {
				utilities.writeToFile(reportFile, "Cleanliness Check in MED_AUC_DATA table - Pass");
		//		System.out.println("Cleanliness Check in MED_AUC_DATA table - Pass");
			}
