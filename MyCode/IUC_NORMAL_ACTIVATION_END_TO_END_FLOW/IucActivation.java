...
import IUC_NORMAL_ACTIVATION_END_TO_END_FLOW.SiebelOUILoginPF;
...
public class IucActivation {
	...
	public IucActivation(String reportFile, String datasetLogFile, String datasetFolderPath, CommonUtilitiesWriterOLD utilities){
	...
	public int iucActivate(int cellId) throws InterruptedException, IOException {
		...
		CommonUtilitiesWriterOLD cu = new CommonUtilitiesWriterOLD(reportFile,datasetLogFile);
