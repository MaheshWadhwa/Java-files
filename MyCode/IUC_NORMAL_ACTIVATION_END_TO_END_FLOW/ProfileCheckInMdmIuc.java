...
public class ProfileCheckInMdmIuc {
	...
	public ProfileCheckInMdmIuc(String reportFile, String datasetLogFile, String datasetFolderPath, CommonUtilitiesWriterOLD utilities){
	...
	public int checkInMdm(String CustomerId) throws InterruptedException, IOException {
		...
		int checkCounter = 0;
		conditionCounter = 0;
		utilities.writeToFile(reportFile, System.lineSeparator()+"Validate Profile in Siebel"+System.lineSeparator()+"--------------------------");
