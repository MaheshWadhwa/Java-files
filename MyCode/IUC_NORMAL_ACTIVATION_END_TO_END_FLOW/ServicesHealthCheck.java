...
public class ServicesHealthCheck {
	...
	public ServicesHealthCheck(String reportFile, String datasetLogFile, String datasetFolderPath, CommonUtilitiesWriterOLD utilities){
	...
	public int servicesCheck() throws IOException, InterruptedException {
		...
		try {
			...
			session.setPassword("Mobily@123");
