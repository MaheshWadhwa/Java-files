...
public class DataCheckInMedAuc 
{
	...
	public DataCheckInMedAuc(String reportFile, String datasetLogFile, String dataCheckFolderPath, CommonUtilitiesWriterOLD utilities){
	...
	public int execute(String Imsi) throws ClassNotFoundException, SQLException, InterruptedException,IOException,FileNotFoundException
	{
	...
	public static void status(String Imsi) throws ClassNotFoundException, SQLException, InterruptedException,IOException,FileNotFoundException
	{
		try
		{
			...
			utilities.writeToFile(datasetLogFile, "Executed MED_AUC_DATA check Query"+System.lineSeparator()+"---------------------------------"+System.lineSeparator()+query);

			// Assigning result set to workbook
			HSSFWorkbook wb=new HSSFWorkbook();
			HSSFSheet sht=wb.createSheet("MED_AUC_DATA");
