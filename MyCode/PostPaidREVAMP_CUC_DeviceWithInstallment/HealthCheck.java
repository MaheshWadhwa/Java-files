...
*/
	...
	public HealthCheck(String runlog,String reportfile,CommonUtilitiesWriter report)
	{
		
		HealthCheck.report=report;
		HealthCheck.reportfile=reportfile;
		HealthCheck.runlog=runlog;
	...
	public int execute() throws IOException, InterruptedException {
		...
		File file_data=new File ("C:\\Automated_Execution\\Input\\TestData_CUCPostPaidRevamp_DeviceWithInstallment.xls");
