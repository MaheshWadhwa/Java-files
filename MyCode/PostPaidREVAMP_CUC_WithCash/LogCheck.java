...

{
	...
	public LogCheck(String runlog,String reportfile,String Actipre,CommonUtilitiesWriter report)
	{
		LogCheck.runlog=runlog;
		LogCheck.reportfile=reportfile;
		LogCheck.Actipre=Actipre;
		LogCheck.report=report;	
	}
