...
public class ConsumerActivationMain {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException, SQLException 
	{
		...
		xlFile = new File("C:\\Automated_Execution\\Input\\TestData_Revamp_IUC _WithCashBack.xls");
		...
		outputpath="C:\\Automated_Execution\\Output\\Revamp_IUC_CashBack\\".concat(output);
