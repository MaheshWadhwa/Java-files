...
public class CommonUtilitiesWriterOLD {

	static PrintWriter writer = null;
	static String reportFile = "";
	static String datasetLogFile = "";

	public CommonUtilitiesWriterOLD(PrintWriter writer){
		CommonUtilitiesWriterOLD.writer = writer;
	}
	
	public CommonUtilitiesWriterOLD() {
		// TODO Auto-generated constructor stub
	}
	
	public CommonUtilitiesWriterOLD(String reportFile, String datasetLogFile){
		CommonUtilitiesWriterOLD.reportFile = reportFile;
		CommonUtilitiesWriterOLD.datasetLogFile = datasetLogFile;
	}
