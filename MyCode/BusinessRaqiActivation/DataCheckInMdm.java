...
public class DataCheckInMdm {
	...
	public int execute(String Msisdn, String Sim1, String Sim2, String Sim3) throws InterruptedException, IOException {
	...
	public void checkSim(String Sim,String type) throws InterruptedException{
		//**************************************************************************			
		//IF IT IS SIM
		...
		try{
			...
			try{
				...
				utilities.writeToFile(datasetLogFile, "Exception occured while checking "+type+" in MDM.");
			}
		} 
		Thread.sleep(2000);
		utilities.takeScreenShotMethod(driver, dataCheckFolderPath, "Data_Check_In_MDM_"+type);
	} // end of checkSim method
}