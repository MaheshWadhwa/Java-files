...
public class BusinessRaqiMain {

	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException, SQLException {

		// Variable Declaration
		String inputFile = "C:\\Automated_Execution\\Input\\TestData_Business_Raqi.xls";
		String outputFolderPath = "C:\\Automated_Execution\\Output\\Business_Raqi";
...
/*
		...
		xlFile = new File("C:\\Automated_Execution\\Input\\TestData_Business_Raqi.xls");
		inputStream = new FileInputStream(xlFile);
...
/*			DataCleanlinessCheckBusRaqi dataCheckObj = new DataCleanlinessCheckBusRaqi(xSim1,xImsi1,xSim2,xImsi2,xSim3,xImsi3,xMsisdn,reportFile,datasetLogFile,datasetFolderPath,utilities);
...
*/
			...
			CorporateProfileCreation profileCreationObj = new CorporateProfileCreation(reportFile,datasetLogFile,datasetFolderPath,utilities);
			...
			BusinessRaaqiActivation activationObj = new BusinessRaaqiActivation(reportFile,datasetLogFile,datasetFolderPath,utilities);
