...
public class CommonUtilitiesWriter {
	...
	public void writeToFile(String file,String message) throws InterruptedException{
		Thread.sleep(1000);
...
//			System.out.println("creating directory: " + folderName);
	...
	public void clickWE(WebDriver driver,String strPath) throws InterruptedException{
...
//		writer.println("Clicked on "+we.getText());
	...
	public void selectDD(WebDriver driver, String strPath, String strOpt) throws InterruptedException{
		WebElement we = new WebDriverWait(driver,30).until(ExpectedConditions.elementToBeClickable(By.xpath(strPath)));
		we.click();
...
//		writer.println("Clicked on "+strOpt);
	...
	public void selectOption(WebDriver driver,String selectTagID,String opt) throws InterruptedException{
