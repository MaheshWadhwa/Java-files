...
public class ProfileCheckInMdmCorporate {
	...
	public ProfileCheckInMdmCorporate(String reportFile, String datasetLogFile, String datasetFolderPath, CommonUtilitiesWriter utilities){
		ProfileCheckInMdmCorporate.datasetFolderPath = datasetFolderPath;
		ProfileCheckInMdmCorporate.reportFile = reportFile;
		ProfileCheckInMdmCorporate.datasetLogFile = datasetLogFile;
		ProfileCheckInMdmCorporate.utilities = utilities;
	...
	public int checkInMdm(String CustomerId) throws InterruptedException, IOException {
		...
		// Selecting Commercial Registration ID
		driver.findElement(By.xpath(".//*[@id='form2:input-identificationType']/div[2]/span")).click();
		driver.findElement(By.xpath("//li[text()='Commercial Registration ID']")).click();
		Thread.sleep(2000);
