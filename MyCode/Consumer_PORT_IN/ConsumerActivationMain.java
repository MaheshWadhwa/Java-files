...
public class ConsumerActivationMain {
		
/*	public static String pat;
	public static File Dataprecheck;
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException, SQLException 
	{
		...
		xlFile = new File("D:/java life/Office Input files/TestData_Consumer1.xls");
		...
		outputpath="C:\\Automated_Execution\\Output\\Consumer_MNP\\".concat(output);
		...
		for(i=1;i<=iterations;i++)
		{
			...
			xlFile = new File("C:\\Automated_Execution\\Input\\TestData_Consumer_MNP.xls");
			inputStream = new FileInputStream(xlFile);
	...
	/*		check=0;
			...
			check=0;
			ConsumerActivation acti=new ConsumerActivation(runlog,reportfile,datapre,report);
			check=acti.ConActivation(cellId);
