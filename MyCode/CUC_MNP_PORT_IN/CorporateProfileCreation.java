...
import CUC_MNP_PORT_IN.SiebelOUILoginPF;
...
public class CorporateProfileCreation {
	...
	public int createProfile(int cellId) throws InterruptedException, IOException {
		...
		File xlFile = new File("C:\\Automated_Execution\\Input\\TestData_CUC.xls");
		...
		*/
		...
		cu.selectDD(driver, ".//*[@id='a_2']/div/table/tbody/tr[5]/td[7]/div/input", xCDIdType);
		...
		cu.selectDD(driver, ".//*[@id='a_2']/div/table/tbody/tr[11]/td[5]/div/input", xCDDateFormat);
		...
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[9]/td[3]/div/input",xCCCompanyCategory);
		...
		cu.selectDD(driver, ".//*[@id='a_2']/div/table/tbody/tr[17]/td[3]/div/input", xCCDeliveryPreference);
		//cu.selectDD(driver,".//*[@id='s_2_1_10_0_icon']",xCCDeliveryPreference);
		
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[16]/td[7]/div/input",xAPTitle);
		...
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[22]/td[8]/div/input", xAPDobFormat);
		...
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[27]/td[5]/div/input",xAPIdType);
		...
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[33]/td[3]/div/input",xAPDateFormat);
		//cu.selectDD(driver, ".//*[@id='s_2_1_56_0_icon']", xAPDateFormat);
		
		
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[17]/td[8]/div/input",xAPNationality);
		//cu.selectDD(driver, ".//*[@id='s_2_1_58_0_icon']", xAPNationality);
		
		//cu.selectDD(driver, ".//*[@id='s_2_1_59_0_icon']", xAPDeliveryPreference);
		
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[19]/td[7]/div/input",xAPDeliveryPreference);
		...
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[27]/td[7]/div/input",xAPGender);
		...
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[28]/td[3]/div/input",xDCountryOfOrigin);
		
		//cu.selectDD(driver, ".//*[@id='s_2_1_26_0_icon']", xDCompanyType);
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[30]/td[3]/div/input",xDCompanyType);
		...
		cu.selectDD(driver, ".//*[@id='a_2']/div/table/tbody/tr[23]/td[5]/div/input", xCAAddrType);
		
		cu.selectDD(driver,".//*[@id='a_2']/div/table/tbody/tr[39]/td[11]/div/input", xCCCompanyName);
	...
	//	cu.select(driver,".//*[@id='a_2']/div/table/tbody/tr[13]/td[3]/div/input", xCCDiscount);
		...
		*/
		...
		FileInputStream fis = new FileInputStream("C:\\Automated_Execution\\Input\\TestData_CUC.xls");
