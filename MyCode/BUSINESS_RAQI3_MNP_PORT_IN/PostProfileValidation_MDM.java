...
public class PostProfileValidation_MDM {
	...
	static String post_path=Raaqi3BusinessMNPPortINActivationMain.Postpre;
	static int checkCounter;
	

	public  int ProfileValidation_MDM() throws InterruptedException, IOException {
		...
		String xIdNo = testSheet.getRow(2).getCell(cellId).getStringCellValue();
		...
		Thread.sleep(2000);
		report.takeScreenShotMethod(driver, post_path.concat("\\Profile_Creation"), "Profile Validation in MDM");
		driver.close();
