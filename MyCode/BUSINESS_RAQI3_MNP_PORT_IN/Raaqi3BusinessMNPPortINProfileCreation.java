...
public class Raaqi3BusinessMNPPortINProfileCreation {
	
	static int cellId = 2;
	static int row;
	//static int cellId=ConsumerMNPPortINActivationMain.cellId;
	...
	public int acti() throws IOException, InterruptedException
...
//	public static void main(String[] args) throws IOException, InterruptedException 
	{
	    ...
	    PostProfileValidation_MDM profileCheckInMdmObj = new PostProfileValidation_MDM();
		int check = profileCheckInMdmObj.ProfileValidation_MDM();
