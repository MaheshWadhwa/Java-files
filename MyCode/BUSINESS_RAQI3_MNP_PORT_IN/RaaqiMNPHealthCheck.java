...
public class RaaqiMNPHealthCheck

{


	static CommonUtilitiesWriter report=new CommonUtilitiesWriter();
	static String runlog=Raaqi3BusinessMNPPortINActivation.runlog;
	static String reportfile=Raaqi3BusinessMNPPortINActivation.reportfile;
